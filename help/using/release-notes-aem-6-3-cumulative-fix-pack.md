...
* Le contenu d’un composant est modifié dans l’instance d’auteur, puis activé n’est pas visible dans l’instance Publish tant que le composant n’a pas été redémarré **com.day.cq.pepersonalization.impl.TargetedContentManagerImpl** (NPR-32489 et NPR-32232).
...
>[!NOTE]
>
>Les packages complémentaires AEM Forms permettent d’harmoniser les fonctionnalités des formulaires avec les Service Packs et les packs de correctifs cumulés AEM. Par conséquent, il est impératif d’installer le module complémentaire AEM Forms après l’installation d’AEM Service Pack, de Cumulative Fix Pack ou de Feature Pack.
...
* Assets sélectionné (en mode Colonne dans l’interface utilisateur tactile) avant de sélectionner l’option de filtre dans la liste déroulante Contenu uniquement , puis de sélectionner l’option de déplacement sont également déplacés (NPR-30693).
...
* Lorsqu’un utilisateur déploie une page, la boîte de dialogue de configuration de déploiement affiche les chemins de Live Copy en double (NPR-30438).
...
* Un utilisateur se concentre sur les champs du rail de gauche et utilise un raccourci clavier pour coller du contenu. Ce faisant, il colle le contenu du Presse-papiers de l’éditeur de page au lieu du contenu copié à partir des champs du rail de gauche (NPR-31173).
* Lorsqu’un utilisateur modifie un fragment de contenu, la variation déjà supprimée du fragment de contenu est restaurée (NPR-31272).
...
* L’agrégation vidéo par Dynamic Video renvoie uniquement les 100 premiers éléments du jeu de résultats. NPR-30441 : correctif pour CQ-4213561
* Problème de connectivité du balisage intelligent d’Adobe via DataPower. NPR-30026 : correctif pour CQ-4269457
* La décompression d’une archive dont le nom contient un signe de pourcentage (%) ne peut pas être ouverte à l’aide de l’interface Assets. NPR-29989 : correctif pour CQ-4270467
...
* Lors de la génération d’une exportation CSV, l’ajout de colonnes personnalisées pour le mode Liste interrompt le rapport. NPR-30208 : correctif pour CQ-4273344
...
* La valeur du paramètre de requête resourceType est copiée dans la valeur d’un attribut de balise HTML encapsulé entre guillemets doubles. NPR-29832 : correctif pour CQ-4255365

### Communities {#communities-1}

* Problème de contenu en double avec la console de modération AEM Communities. NPR-30667 : correctif pour CQ-4276829
...
* Lorsqu’un test de chargement est effectué sur le service HTML to PDF, il échoue avec une erreur et les paramètres de type de fichier sont supprimés du serveur AEM Forms. NPR-30111, NPR-30086 : correctif pour CQ-4271495
...
* Impossible de supprimer un rendu d’image sur une ressource vidéo de la page Détails de la ressource. NPR-29417 : correctif pour CQ-4268675
...
* CoralUI, lorsqu’il est utilisé avec Multifield, stocke le paramètre fileReferenceParameter au niveau du composant au lieu du niveau du multichamp. NPR-29535 : correctif pour CQ-4266129
...
* Le champ de chemin d’accès s’ouvre à la racine, quel que soit le chemin d’accès spécifié pour la recherche. NPR-29398 : correctif pour CQ-4268897
...
* Les propriétés vides et les propriétés multiples ne sont pas propagées à partir du plan directeur lors du déploiement. La réinitialisation de la Live Copy avec le plan directeur ne fonctionne pas pour les composants. NPR-29252 : correctif pour CQ-4264928, CQ-4264926, CQ-4267722
...
* Vous ne pouvez pas exporter des fragments d’expérience vers la cible lorsqu’une image dynamique est utilisée. Correctif pour CQ-4269606

### Réplication {#replication}

* Le composant Agent de réplication est sensible à une vulnérabilité qui divulgue des informations sensibles à des utilisateurs non autorisés. NPR-29613 : correctif pour Granite-25070
* Les données fournies par l’utilisateur ne sont pas placées dans une séquence d’échappement en sortie dans le composant `cq/replication/components/agent`, ce qui entraîne une vulnérabilité XSS (Cross-Site Scripting) stockée. NPR-29452 : correctif pour CQ-4266263
...
* Le processus CommandLineProcess échoue avec un nom de fichier avec un guillemet simple. NPR-28805 : correctif pour CQ-4262287
* Les valeurs sont différentes entre la page de collection et la page de collection lors de l’utilisation du filtre. NPR-28642 : correctif pour CQ-4261405
...
* Impossible de supprimer les rendus d’image d’une ressource vidéo de la page des détails de la ressource. NPR-29149 : correctif pour CQ-4266073
...
* Le fichier `coral.js` comprend une version vulnérable de la bibliothèque `handlebars.js`. NPR-26973 : correctif pour CQ-4255377
* L’utilisation d’un composant cible avec un composant Conteneur de mises en page et Texte imbriqué renvoie une erreur JavaScript &quot;Impossible de lire la propriété currentPos de valeur nulle&quot; lors de la modification du texte ou du clic sur le conteneur. NPR-29077 : correctif pour CQ-4246594
* (Interface utilisateur tactile) Impossible de mettre à jour en masse les balises vers les pages qui sont déjà balisées avec différentes balises. NPR-28729 : correctif pour CQ-4262922
* L’ouverture de la variation en mode Carte provoque une erreur 500. NPR-28611 : correctif pour CQ-4263571
* Déploiement d&#39;une structure qui a été déplacée dans une piste principale vers un `cq:moveTarget` incorrect. NPR-28968 : correctif pour CQ-4265280
...
* Le fait de cliquer sur une balise supprime l’événement global de la souris et la boîte de dialogue est figée en mode déplaçable. NPR-28641 : correctif pour CUI-7294
...
* Activation de l’option de sélection des éléments par page sur la page d’affichage Jeu de stratégies.
...
* Impossible d’envoyer à partir de Workspace si le bouton contient un caractère multipoint. NPR-29014 : correctif pour CQ-4263172

#### Forms - Document Security {#forms-document-security}

* Activez l’option pour sélectionner des éléments par page sur la page d’affichage Jeu de stratégies. NPR-29243 : correctif pour CQ-4268567 et CQ-4265132
...
* Un comportement différent est observé lors de la prévisualisation d’un XDP en tant que PDF par rapport au même XDP qu’un HTML dans Designer. NPR-28602 : correctif pour CQ-4260239
...
* Ajout d’un libellé aria pour le bouton Mode Liste et Carte.
...
* Ajout d’un libellé aria pour le bouton Mode Liste et Carte. NPR-27736 : correctif pour CQ-4254027
...
* Erreur lors de la recherche de caractères tels que `(`, `+` et `?` dans une recherche rapide. NPR-28212 : correctif pour CQ-4260969
...
* Le module externe de style n’est pas pris en charge en mode plein écran de l’éditeur de texte enrichi. NPR-27622 : correctif pour CQ-4258674
...
* Impossible de définir une stratégie de modèle sur Parsys imbriqué sans la définir sur le composant parent. NPR-27987 : correctif pour CQ-4246095
...
* L’annulation de l’héritage de LiveCopy fonctionne désormais correctement sur les conteneurs ciblés, car les actions s’affichent. NPR-28129 : correctif pour CQ-4259813

#### Réplication {#replication-1}

* DispatcherFlushRules a interrompu la réplication dans 6.3.3.1 NPR-28150 : correctif pour CQ-4261401
...
* La configuration de l’option du composant cible n’est pas disponible pour les audiences à l’exception de l’audience par défaut. Correctif pour CQ-4261370
...
* L’ajout ou la suppression d’éléments dans la liste déroulante ne se met pas à jour lors de la vérification des éléments de case à cocher. NPR-28224 : correctif pour CQ-4252834
...
* Ajout de la prise en charge de l’onglet Règles et de son application dans le dossier de ressources dans le schéma de métadonnées de dossier.
* Activation de la prise en charge de la pagination pour la page de liste de groupes lors de la publication.
* Activation de la configuration de la notification unreadCount avec n’importe quel nombre. La valeur par défaut est définie sur 20.
...
* Amélioration de la requête afin qu’elle utilise la fonction ExpiryNotification . NPR-26999 : correctif pour CQ-4251188
...
* L’ajustement des références de ressources ne parvient pas à mettre à jour les références des ressources qui font partie de Sling ResourceCollections. NPR-26759 : correctif pour CQ-4252605
* Le téléchargement par le biais du partage de lien renvoie un fichier zip vide ou corrompu. NPR-27997 : correctif pour CQ-4259686
...
* Exception de pointeur nul lors de l’utilisation d’un formulaire Core Components avec un formulaire Foundation. NPR-27333 : correctif pour CQ-4249176
...
* Lorsque l’éditeur de texte enrichi est combiné à plusieurs champs, l’erreur TypeError: fieldAPI.getName n’est pas une fonction à l’adresse foundation.js se produit. NPR-27146 : correctif pour CQ-4253155, CQ-4259967
* L’option Mise au point/curseur reste dans l’éditeur de texte enrichi même lorsque vous cliquez sur un bouton radio dans le navigateur Safari. NPR-27144 : correctif pour CQ-4249635
* La page apparaît vide lorsque l’utilisateur tente de modifier le fragment de contenu. NPR-27669
...
* La vidéo n’est pas lue dans l’éditeur de paramètres prédéfinis de la visionneuse pour la visionneuse de médias mixtes. Correctif pour CQ-4251442
...
* L’interface utilisateur du schéma de métadonnées de dossier est rompue après l’installation de SP3. Correctif pour CQ-4257737
...
* La limite d’abonnement de l’utilisateur est limitée à 1 000. NPR-27615 : correctif pour CQ-4254689
...
* Le lien des réponses ne fonctionne pas lors d’un clic sur la ligne. NPR-24556 : correctif pour CQ-4256138
...
* Le libellé d’état d’achèvement de la ressource Scorm d’activation apparaît vide dans l’interface utilisateur. NPR-27152 : correctif pour CQ-4249994
* Lors de l’activation de **Autoriser les privilégiés**, les membres privilégiés ne doivent pouvoir composer que pour les utilisateurs qui sont membres de la communauté. NPR-27901 : correctif pour CQ-4251235
...
* Enregistrer et fermer sur les propriétés de la page ne revient pas à la page appropriée dans AEM WAR avec Tomcat. NPR-27567 : correctif pour Granite-23671

* Le texte saisi est perdu par l’intermédiaire de la fonction sourceEdit après l’enregistrement. Correctif pour CQ-4259273
...
* Mise à niveau du créateur de formulaires vers la dernière version de Handlebars.
* Ajout d’un servlet de configuration pour la configuration de modification de l’éditeur de texte enrichi en mode boîte de dialogue.
...
* Lorsque le découplage IDS est activé, le workflow Ressource de mise à jour de gestion des actifs numériques ne lie plus les références. NPR-26135 : correctif pour CQ-4250933
* La décompression d’une archive créée par l’étape de décompression avec un dossier nommé avec un % ne s’ouvre pas. NPR-26275 : correctif pour CQ-4251482
* Un guillemet simple empêche la mise à jour des métadonnées. NPR-26808 : correctif pour CQ-4254305
...
* Le partage de liens de ressources ne permet pas d’ajouter plusieurs utilisateurs internes avec un identifiant utilisateur numérique. NPR-26206 : correctif pour CQ-4251466
* Corruption des fichiers zip compressés avec l’algorithme deflate64. NPR-26793 : correctif pour CQ-4253995
* Le processus de génération de miniatures ne fonctionne pas correctement pour les fichiers de PDF complexes, ce qui se traduit par des miniatures, où une partie de l’image est manquante. NPR-26057 : correctif pour CQ-4250944
...
* Les stratégies ne contrôlent pas les fonctionnalités de l’éditeur de texte enrichi dans la boîte de dialogue de modification. NPR-27059, NPR-26750 : correctif pour CQ-4241130
...
* L’ajout de &quot;caractère spécial&quot; fait défiler la boîte de dialogue de l’éditeur de texte enrichi vers le haut. NPR-26435 : correctif pour CQ-4249869
...
* Les champs de balise de modèle de fragment de contenu structuré ne reflètent pas les opérations de déplacement de balise. NPR-26801 : correctif pour CQ-4251805
...
* Pour créer une variation en tant que Live Copy, l’utilisateur doit actualiser la page afin de la refléter. NPR-26663 : correctif pour CQ-4254328
* (IU classique) En revenant aux propriétés de la page, l’image miniature n’utilise plus l’héritage et disparaît de l’administrateur du site et du sidekick, et l’image s’affiche comme vide. NPR-26562 : correctif pour CQ-4252346
...
* La réplication utilise le jeton expiré pour OAuth, provoquant plusieurs erreurs. NPR-25894 : correctif pour GRANITE-22388
...
* L’accès simultané de plusieurs agents de réplication entraîne des exceptions dans les journaux lors de l’accès au noeud de jeton d’accès. NPR-26964 : correctif pour Granite-23276, Granite-23155

#### ContextHub {#contexthub}

* Le fichier `coral.js` comprend une version vulnérable de la bibliothèque `handlebars.js`. Correctif pour CQ-4255377
...
* Le module externe Coller à partir de Word ne parvient pas à charger plusieurs images. NPR-26728 : correctif pour CQ-4253638
...
* Problème lors de la recherche sur le composant de forum. NPR-26577 : correctif pour CQ-4251303
...
* La suppression de la publication fonctionne, mais renvoie une erreur sur la console et la publication reste visible dans l’interface utilisateur. NPR-26292 : correctif pour CQ-4252803
...
* Exception de pointeur nul lors de l’ajout de membres et de groupe aux paramètres de rôle et de l’autorisation du membre privilégié dans la fonction de blog. NPR-21732, NPR-27176 : correctif pour CQ-4255909
* La modification du site et l’ajout de membres dans les paramètres de rôle renvoie une exception null pointer . NPR-27132 : correctif pour CQ-4255909
...
* L’espace de travail se bloque par intermittence et affiche à plusieurs reprises les points de départ. NPR-26461 : correctif pour CQ-4253439
...
* Une exception null pointer est générée lorsqu’un formulaire adaptatif ou un point de départ associé à un jeu de formulaires non prérempli est ouvert. Correctif pour CQ-4256124
...
* Une exception est générée lors de la définition d’un modèle de recherche à partir de l’interface utilisateur d’administration, puis de l’utilisation de la même pour effectuer une recherche dans l’espace de travail AEM Forms. Correctif pour CQ-4255649
* Les détails du suivi des processus situés sous les applications et dont le nom contient des parenthèses ne sont pas affichés dans HTML Workspace. Correctif pour CQ-4242101
* L’enregistrement des modifications dans l’écran des préférences d’HTML Workspace renvoie une exception. Correctif pour CQ-4241485
...
* Échec du chargement de esapi.properties en tant que ressource classloader dans WAS9. Correctif pour CQ-4255631
...
* Correction des problèmes signalés dans le rapport d’analyse de code statique de PDFG. NPR-23251 : correctif pour CQ-4213930
...
* L’assurance que la condition de rendu renvoie un résultat sain si expressionResolver est nul.
...
* Les facettes de recherche de l’administrateur de ressources disparaissent dans les panneaux de recherche après prévisualisation. NPR-23964 : correctif pour CQ-4244410
...
* Le bouton Publish/Annuler la publication sur Brand Portal ne doit pas être disponible pour les fragments de contenu. NPR-23318 : correctif pour CQ-4245086
...
* Les requêtes Dynamic Media n’utilisent pas de client commun proxy/HTTP. NPR-10727 : correctif pour CQ-45695, CQ-88800
* Impossible d’annoter une seule ressource vidéo MP4 de rendu dans Dynamic Media S7 (DMS7). NPR-22046 : correctif pour CQ-4215912
...
* Problèmes d’affichage/de sélection du rendu dynamique avec un grand nombre de paramètres d’image prédéfinis. NPR-23151 : correctif pour CQ-4217511
* Problème avec la vidéo de codage Dynamic Media : modification/rechargement du lanceur. NPR-23237 : correctif pour CQ-4240260
* Correctif de gestion des proxys pour le transfert HTTP dans Dynamic Media S7. NPR-24001 : correctif pour CQ-244140

### Sites {#sites-8}

* Incohérences de Query Builder résultant de différentes traductions xPath entre la version 6.2 et la version 6.3. NPR-23245 : correctif pour CQ-4240396
* L’onglet Miniature de la propriété de page ne fonctionne pas lors de l’extension de la boîte de dialogue. NPR-22844 : correctif pour CQ-4241474
...
* Un autre utilisateur d’une autre session peut modifier une page verrouillée par un utilisateur au cours de la première session. NPR-23057 ; correctif pour CQ-4199017
* Corrigez l’option réorganisable en mode Liste. NPR-23065 : correctif pour CQ-4239321
* (Éditeur de page) L’image d’un composant Image disparaît à nouveau lors de l’ouverture de la boîte de dialogue. NPR-23156 : correctif pour CQ-4239978
...
* Le bouton de déploiement est manquant dans l’onglet Plan directeur pour les variations XF. NPR-23320 : correctif pour CQ-4240404
...
* Après l’ajout d’environ 80 fragments sont ajoutés dans un dossier dans Assets. Des erreurs se produisent lorsque le workflow est déclenché à partir de la console Frise chronologique. NPR-23393 : correctif pour CQ-4211216
* Impossible de faire glisser des images dans la boîte de dialogue de l’éditeur de texte enrichi à partir de l’outil de recherche de contenu. NPR-23403 : correctif pour CQ-4242094
...
* (Éditeur de texte enrichi) Les info-bulles affichent le nom de variable du plug-in au lieu du nom du plug-in lisible. NPR-23550 : correctif pour CQ-4243269
...
* La collecte dynamique n’affiche pas les résultats après l’enregistrement si vous utilisez le prédicat de balise dans la facette de recherche. NPR-23401 : correctif pour Granite-21278
* Patch pour jQuery 1.12.4 de clientlib afin d’inclure un correctif de sécurité. NPR-24128 : correctif pour Granite-20058
* Les traductions d’internationalisation sont désormais mises à jour au redémarrage du lot. NPR-23193 : correctif pour Sling-7190
...
* (Target) Les campagnes ne sont pas activées lorsque vous utilisez un type d’API tel que XML. NPR-23199 : correctif pour CQ-4240936****
* La réplication de référence de configuration échoue avec une structure de dossiers intermédiaire. NPR-23485 : correctif pour CQ-4242751
...
* Les propriétés Live Copy ne sont pas supprimées lors de la création de copies de langue. NPR-23123 : correctif pour CQ-4230641

### Interface utilisateur {#user-interface-1}

* Le sélecteur de date ne prend pas en charge la définition manuelle d’un indice de type externe défini par un champ masqué. La modification de l’indicateur de type génère une erreur de conversion. NPR-23371 : correctif pour Granite-21194
* Coral.ColumnView : ajout de la prise en charge de Maj.+clic. NPR-23404 : correctif pour Granite-13338
* Sélectionner RT n’est pas validé lorsqu’un élément avec une valeur vide est sélectionné. NPR-23405 : correctif pour Granite-21283
...
* La recherche dans les communautés échoue pour peu de mots. NPR-23256 : correctif pour CQ-4240717
...
* (ContextPath) La fonctionnalité de message de rupture rompt les configurations et erreurs Jetty lors de la recherche des membres du groupe dans la liste des membres du groupe de la communauté. NPR-23336 : correctif pour CQ-4241519, CQ-4242080
...
* Problèmes lors de l’exécution d’une recherche sur le composant Forum. NPR-23838 : correctif pour CQ-4243770
...
* Les raisons d’indicateur des utilisateurs non marqués restent visibles. NPR-23974 : correctif pour CQ-4243822
...
* Demande d’un mécanisme pour nettoyer les ressources des instances de travail après traitement ou régulièrement. NPR-23638 : correctif pour Granite-21337
...
* Un champ numérique ne respecte pas une valeur minimale. NPR-23967 : correctif pour CQ-4244830
...
* Le service de capture de papier se bloque lors du traitement simultané de fichiers de TIFF (environ 50 Ko). NPR-23556
...
* Lors de la modification du titre ou de la miniature dans les paramètres du dossier de ressources, le groupe d’origine et les autorisations du dossier sont remplacés. NPR-22171 : correctif pour CQ-4216080
* L’interface utilisateur renvoie une erreur erronée &quot;Échec de Publish vers Brand Portal&quot;, tandis que la tâche est ajoutée à la file d’attente de réplication et que les ressources sont publiées vers Brand Portal. NPR-22179 : correctif pour CQ-4205273
* (IU tactile) Emplacement de chargement par défaut des ressources en mode Colonnes. NPR-22465 : correctif pour CQ-4237057
* AEM renvoie une erreur StackOverflow lors de la tentative de copie d’un schéma de ressource de `/conf/global` vers `/conf/mytenant`. NPR-22489 : correctif pour CQ-4235875
...
* HTTP 504 : erreur Délai d’expiration de la passerelle lors de la tentative de partage de collections à l’aide d’un lien de partage. NPR-21928 : correctif pour CQ-4234507
...
* Le téléchargement des ressources échoue lors de l’utilisation de la gestion des droits numériques dans Assets dans Safari. Les utilisateurs ne peuvent pas télécharger de ressources avec une clause de non-responsabilité et des noms de fichier longs. NPR-22747 : correctif pour CQ-4236460 et CQ-4235274
* Faites du partage public l’option par défaut lors de la publication de ressources dans Brand Portal. NPR-21931 : correctif pour CQ-4218816

### Sites {#sites-9}

* Un nouvel élément de la boîte de réception Processus affiche le chemin de la page au lieu du titre de la page. NPR-21634 : correctif pour CQ-4230672
...
* Mode Plein écran de l’éditeur de texte enrichi pour la boîte de dialogue de l’interface utilisateur tactile masque les modules externes de l’éditeur de texte enrichi. NPR-22034 : correctif pour CQ-4235457
...
* (IU classique) Le code HTML de sortie de l’éditeur de texte enrichi ajoute &quot;list-position-style: inside;&quot; comme style intégré à la balise &lt;ul> . NPR-22145 : correctif pour CRTE-114
* Rendre TreeNode à l’attribut name lorsque le texte est vide. NPR-22146 : Correctif pour CQ-4234724 / CQ-4236300
...
* Le filtrage du champ de balise ne fonctionne pas comme prévu lors de la saisie de texte. NPR-22236 : correctif pour CQ-4236655
...
* Problèmes de persistance lorsque les magasins ContextHub remplacent le calque de persistance par défaut lors de l’initialisation. NPR-22479 : correctif pour CQ-4218399
* Launch avec plusieurs pages ne publie pas de sous-pages sur les serveurs de publication si l’option &quot;inclure des sous-pages&quot; n’est pas cochée sur la première racine de contenu. NPR-22482 : correctif pour CQ-4237818
* (IU tactile) La suppression des lancements par le biais de la console d’IU classique rend toutes les pages non modifiables. NPR-22491 : correctif pour CQ-4225074
...
* Lors de l’ouverture du composant à l’aide du mode intégré, les modules chargés précédemment ne sont pas visibles la seconde fois. NPR-22591 : correctif pour CQ-4236850
...
* Après avoir inversé une image ajoutée dans le composant d’image d’une page, les modifications ne sont pas enregistrées et l’image d’origine est affichée sur la page. La prise en charge du rendu a été ajoutée au composant image de base via [https://github.com/adobe/aem-core-wcm-components/pull/141](https://github.com/adobe/aem-core-wcm-components/pull/141). NPR-22801 : correctif pour CQ-4221539
* Lorsque l’utilisateur tente de supprimer l’ancre existante du menu d’ancrage, la fenêtre du composant Éditeur de texte enrichi se ferme et les modifications ne sont pas enregistrées. NPR-22802 : correctif pour CQ-4238167
* Le filtre Omni-recherche n’affiche pas toutes les actions dans la console Sites. NPR-22804 : correctif pour CQ-4239007
...
* L’activation d’une page avec des instances de publication de donne un état vert au lieu de passer à ambre. NPR-22927 : correctif pour CQ-4236310
...
* Le servlet Sling Exporter n’exporte pas correctement les caractères japonais. NPR-22153 : correctif pour CQ-4228920
...
* Lors de la fourniture d’un fichier at.js ou mbox.js personnalisé, le script inclus est écrit sur la page sous forme de texte au lieu de balises d’HTML. NPR-22441 : correctif pour CQ-4203691
...
* PersonalizationDataSource renvoie une exception null pointer en raison d’un noeud `jcr:content` manquant. NPR-22850 : correctif pour CQ-4222122
...
* Les utilisateurs ne peuvent pas voir les valeurs de paramètre statique de test dans l’appel de mbox, ce qui est visible lors du test avec AT.js comme bibliothèque cliente dans la configuration cloud. NPR-21930 : correctif pour CQ-4234520
...
* Reflet des scripts intersites (XSS) lors de l’utilisation d’un sélecteur non valide. Correctif pour CQ-4270397
...
* Il se peut que LogbackManager manque une configuration OSGi au moment du démarrage. NPR-23060 : correctif pour Granite-19791
...
* Ajout de la prise en charge de la création de fichiers PDF conformes à PDF/A-2a ou PDF/A-3a.

### Package de modules complémentaires Forms {#forms-add-on-package-9}

#### IU d’administration Forms {#forms-admin-ui}

* Le mot de passe est visible en texte brut lorsque vous examinez le champ du mot de passe dans les pages de configuration des connecteurs ECM. NPR-22508 : correctif pour CQ-4236065
...
* Les fonctions personnalisées de l’éditeur de règles ajoutent une valeur supplémentaire après l’appel de fonction . Par conséquent, la validation échoue même si la fonction personnalisée renvoie true (vrai). NPR-22481 : correctif pour CQ-4235499
...
* (Microsoft® Edge) (IE11) Le composant Champ de texte de formulaire adaptatif avec un champ multiligne affiche `Null` comme valeur par défaut au lieu d’être vide. NPR-22284 : correctif pour CQ-69107
...
* Le composant Conteneur AEM Forms n’est pas disponible pour modification une fois que le formulaire incorrect est configuré dans la page AEM Sites. Correctif pour CQ-4237456
* Les tests de développement échouent lors de l’exécution sur les serveurs JEE. Correctif pour CQ-4222082
* Échec des tests AF sur les serveurs JEE en raison de problèmes de minification dans la structure Calvin. Correctif pour CQ-4217220
...
* Les Forms qui sont modifiées après la publication de la page ne sont pas republiées. NPR-23013 : correctif pour CQ-4236566
...
* (HTML Workspace) La préparation des données est déclenchée lors de la fermeture d’un formulaire dans l’espace de travail. NPR-21127 : correctif pour CQ-4224574
...
* Les navigateurs ne peuvent pas stocker les informations d’identification saisies dans les formulaires HTML. NPR-21762 : correctif pour CQ-4206543
...
* Ajout de la prise en charge de la création de fichiers PDF conformes à PDF/A-2a ou PDF/A-3a. NPR-23021 : correctif pour CQ-4214172

#### Concepteur Forms {#forms-designer-1}

* L’identifiant PDF/UA est absent lors de l’enregistrement en tant que PDF à partir de Designer. NPR-23137
...
* Les hyperliens insérés définis dans Designer ne sont pas balisés ou comportent un texte de remplacement lorsqu’ils sont enregistrés en tant que PDF à partir de Designer. NPR-23133
...
* Exception rencontrée lors de la signature numérique d’un document de PDF au moyen de HSM. NPR-21154 : correctif pour CQ-4226978
...
* Impossible de télécharger des ressources avec des espaces dans la page de vérification de licence. NPR-20067 : correctif pour CQ-4216557
...
* Les utilisateurs ne peuvent pas télécharger des ressources dont les noms de fichier et la clause de non-responsabilité sont longs. NPR-20254
...
* Trop de caractères dans OmniSearch peut provoquer le blocage du serveur AEM. NPR-20434 : correctif pour CQ-4223602
* Le défaut de métadonnées de l’API de ressources de gestion des actifs numériques rompt les API xmp-write-back. NPR-20607 : correctif pour CQ-4220455
...
* Le nom du processus saisi doit être disponible dans la zone Notification lors de la publication d’une page via Gérer la publication. NPR-20046 : correctif pour CQ-4221586
...
* Le module externe de texte enrichi ne fonctionne pas pour la barre en ligne et plein écran dans l’interface utilisateur tactile à plusieurs champs. NPR-20973
...
* Après la création d’un site Communities, les utilisateurs ne peuvent pas l’ouvrir à partir du plan du site, car le chemin d’accès au contexte n’est pas ajouté en préfixe à l’URL. NPR-20730
...
* Une définition de filtre ambiguë dans le module de contenu entraîne le remplacement des chemins d’accès lors de l’installation de la fonction Search &amp; Promote. NPR-20808

### Mobile On-Demand {#mobile-on-demand}

* Les propriétés de métadonnées des ressources de type TXT sont affichées dans différents éditeurs de métadonnées chaque fois que leurs propriétés sont affichées. NPR-20239
...
* requestAttributes n’est désormais plus défini pour les autres instructions data-sly-resource. NPR-20639 : correctif pour 4226206
...
* Dans certains déploiements personnalisés, les utilisateurs qui tentent de sélectionner une personne désignée dans le module addTask prennent plus de temps pour remplir la liste dans le sélecteur d’utilisateurs. NPR-20283 : correctif pour CQ-4224193
...
* Impossible de définir la valeur du composant Switch entre true et false. NPR-21111
...
* Le nom d’un objet de formulaire XDP tel qu’un sous-formulaire s’affiche sous forme d’info-bulle lorsqu’il n’est pas défini dans les configurations d’accessibilité. NPR-20523
...
* Activation de l’action Publier dans Brand Portal pour le formulaire de schéma de métadonnées par défaut.
...
* Remplacement du rendu côté serveur du temps avec un composant foundation-time.
* Activation de la publication des balises d’AEM vers Brand Portal à partir de la console tagadmin/tagging.
* API JSON publiée pour utiliser des fragments de contenu.
* Le référentiel intégré (Apache Jackrabbit Oak) a été mis à niveau vers la version 1.6.5.

### Ressources {#assets-11}

* Le mappage de deux champs avec la même propriété avec différents types de champs de propriété génère une erreur interne. NPR-19462 : HF pour CQ-4216828
...
* Impossible de charger une liste complète de pages/ressources en mode Colonne à l’aide de Chrome. NPR-19566 : correctif pour CQ-4214248
...
* Le champ Moteur de ciblage de l’assistant de configuration est défini sur ContextHub (AEM) au lieu d’Adobe Target. NPR-19320 : HF pour CQ-4218465
* La section d’audience est corrompue lors de la création de l’expérience. NPR-19110
* La boîte de dialogue Ciblage ne s’affiche pas en mode Ciblage lorsqu’un module cible est modifié et enregistré plusieurs fois. NPR-19144 : correctif pour CQ-4216708
...
* Les valeurs de liste déroulante de champs multicomposites ne sont pas à nouveau renseignées en raison de la modification du code dans Sidekick.js après la mise à niveau de l’instance vers AEM 6.1SP2-CFP3. NPR-19450 : HF pour CQ-4194771
* WCMMode.EDIT ne fonctionne pas pour les composants ciblés en mode création. NPR-19387
* API JSON publiée pour utiliser des fragments de contenu. NPR-19500
* La fonctionnalité Gras, italique et souligné ne fonctionne pas pour les champs de l’éditeur de texte enrichi dans la boîte de dialogue de création. NPR-19670 : NPR-19718 : correctif pour CQ-4219088

### Mobile On-Demand {#mobile-on-demand-1}

* Les problèmes de rendu avec la console d’article d’AEM car l’utilisation d’images en taille réelle la rend lente. NPR-19088
...
* Les bibliothèques de balises personnalisées qui référencent des balises implémentées en tant que script sont introuvables après la mise à niveau vers AEM 6.3. NPR-19087
...
* Le bouton Démarrer le processus après la sélection d’un éditeur de variation XF n’a aucun effet. NPR-19642 : correctif pour CQ-4207796

### Projets {#projects-2}

* Les éditeurs de projet ne peuvent pas copier et coller des ressources dans le dossier de ressources du projet. NPR-19619 : correctif pour CQ-4215321

### Gestion de contenu web {#web-content-management}

* Dans l’écran Déploiement, les cases à cocher correspondant aux pages Live Copy ne peuvent pas être cochées ni décochées. NPR-19518
...
* Les propriétés prêtes à l’emploi et les propriétés d’alignement des images n’apparaissent pas lors de la modification d’une image dans l’interface utilisateur classique. NPR-19488 : HF pour CQ-4217914

### Interface utilisateur {#user-interface-4}

* Lors de l’utilisation du navigateur Google Chrome, les utilisateurs ne peuvent pas charger la liste complète des pages/ressources à l’aide du mode Colonnes dans l’interface utilisateur tactile. NPR-19566 : correctif pour CQ-4214248
...
* Activation de la publication des balises d’AEM vers Brand Portal à partir de la console tagadmin/tagging. NPR-20271 : correctif pour CQ-4223948
...
* Le workflow Envoyer vers JEE ne renvoie pas le paramètre de sortie du côté de JEE à AEM et renvoie l’erreur &quot;Ignorer car la valeur n’est pas primitive&quot;. NPR-20265
* Les formulaires adaptatifs n’autorisent pas les pièces jointes au format PDF dans Safari. NPR-19625
* RestoreGuideState remplace le mappage customcontextproperty. CQ-4222877
* Lors de la configuration de Google `reCaptcha` à l’aide de Cloud Service, dans les environnements nécessitant la configuration de org.apache.http.proxyconfigurator pour les connexions externes, les appels de POST ne semblent pas passer par PROXY. NPR-20454
* Les Forms adaptatives basées sur des schémas XSD envoient des valeurs XML erronées pour les champs numériques des installations dont les paramètres régionaux comportent un séparateur décimal autre que le point (.) ce qui entraîne des erreurs. NPR-20444
* Les paramètres de proxy définis pour la &quot;configuration du proxy des composants HTTP Apache&quot; ne sont pas respectés lors de l’exécution d’une requête HTTP à un serveur tiers. Problèmes de délai d’expiration de connexion à l’aide des appels HTTP GET ou POST. NPR-20457, NPR-20456, NPR-20455, NPR-20451
...
* Les onglets Pièce jointe, Notes et Détails du workflow ne fonctionnent pas dans l’espace de travail lorsque le formulaire est agrandi/réduit et enregistré en tant que brouillon ou transféré. NPR-20243
* Le champ de texte multiligne (TextArea) ne conserve pas de nouveaux caractères de ligne ni de sauts dans le texte après l’envoi de données dans HTML Workspace. NPR-20085

#### Rapports de workflow {#process-reporting}

* Les rapports de processus ne récupèrent pas correctement les données en raison de l’exception null pointer . NPR-19759

>[!NOTE]
>
>Installez le package incorporé de LiveCycle répertorié dans l’article [AEM Forms Versions](aem-forms-releases.md) pour résoudre le problème.
...
* Résolution de problèmes de validation de fragment de contenu
* Modification améliorée des schémas de métadonnées sur les appareils hybrides
...
* Une exception de pointeur null se produit lorsqu’une ressource est déplacée à partir de sa page de propriétés. CQ-4204251
...
* Problèmes liés à l’ajout de nouveaux onglets dans le formulaire Schéma de métadonnées lorsqu’il est modifié dans Chrome sur des périphériques hybrides. CQ-4201810
* Lorsque des ressources en double sont chargées, l’option (supprimer/conserver) est appliquée à toutes les ressources, même si elle n’est pas sélectionnée dans la boîte de dialogue des doublons détectés. CQ-4201673
...
* Les utilisateurs disposant d’autorisations de lecture seule sur l’application ne peuvent pas prévisualiser le contenu à partir de la gestion de contenu AEM Mobile. NPR-17486 : CFP pour CQ-4209690
* Le bouton Créer un catalogue ne fonctionne pas dans le mode Colonnes de la console Catalogue. CQ-4209952
...
* Les composants localisés modifiés ne sont pas restaurés dans leur formulaire d’origine lorsque l’héritage est réappliqué dans une LiveCopy. NPR-18172 : correctif pour CQ-4211379
...
* Le nom de la page n’est pas généré conformément à la convention pour les titres de pages longs. NPR-17633 : correctif pour CQ-4209056
* Problèmes de création de page dans l’IU tactile d’AEM 6.3 déployée sur JBoss® EAP 6.4. NPR-17589 : correctif de CQ-4210137
* Le fournisseur d’état de workflow entraîne le verrouillage de l’instance en présence de groupes imbriqués. NPR-17556 : requête CFP pour CQ-4202056
...
* Correctifs dans les modules de texte de Correspondence Management, les aperçus de lettre et le lancement programmatique pour créer une interface utilisateur de Correspondence Management.
...
* Lors de la modification d’un fragment Correspondence Management, l’éditeur de texte affiche les conditions intégrées avec le texte traité. CQ-4211930
* Lors de la création d’une lettre Correspondence Management, la description de la lettre n’est pas enregistrée. NPR-18089
* La marge supplémentaire au-dessus et au-dessous d’une liste à puces est visible dans l’éditeur de texte, mais pas dans le rendu HTML et PDF. NPR-18126
...
* Le service de PDF Generator ne parvient pas à convertir des images de plus de 100 Mo en documents de PDF. CQ-4208628
* Lorsque vous utilisez le service de PDF Generator avec une reconnaissance optique des caractères de langue japonaise, un PDF inversé est généré. NPR-17602
...
>[!NOTE]
>
>Adobe recommande d’exécuter la validation sur chaque nouveau package d’installation avant de tenter d’installer le package. La pré-validation analyse et signale les erreurs détectées avant l’installation et avertit les utilisateurs de ces erreurs de manière proactive.
>
...
* Les erreurs et avertissements suivants peuvent survenir lors de l’installation du CFP d’AEM 6.3.3.x et peuvent être ignorés en toute sécurité :
   ...
   * Service ServletResolver org.apache.sling.engine.impl.SlingRequestProcessorImpl manquant, impossible de traiter les demandes, envoi de l’état 503
...
* À compter de la version 6.3.1.2, le bouton Publish to Brand Portal pour les collections dynamiques a été supprimé.
...
* Une utilisation élevée du processeur est observée en raison de nombreuses requêtes dans la fonctionnalité de recherche d’administration. NPR-24229
...
>[!NOTE]
>
>Ce paramètre de configuration s’applique aux versions 6.3.2.2 et ultérieures. Il vous demande de mettre à jour manuellement les stratégies de listes de contrôle d’accès (ACL) via CRX-DE, car les listes de contrôle d’accès ne sont pas mises à jour via l’installation CFP en raison de l’acHandling &quot;merge_preserve&quot;.
...
`1)` Au chemin &quot;/content&quot;
`a)` Principal : reference-réglage-service
Type : Autoriser
Privilèges : jcr:read, jcr:modifyProperties
Restrictions : rep:glob=&quot;/&#42;/jcr:content&quot;
`b)` Principal : reference-réglage-service
Type : Autoriser
Privilèges : jcr:read, jcr:modifyProperties
Restrictions : rep:glob=&quot;/&#42;/jcr:content/&#42;&quot;
...
* Configurez la propriété JSON Max results d’Apache Sling.
...
Ce processus permet au servlet de GET Sling de renvoyer tous les noeuds requis.

## Uber Jar {#uber-jar}

Uber Jar pour la version 6.3.3.8 est disponible dans le référentiel Maven public Adobe

Pour utiliser Uber Jar dans un projet Maven, reportez-vous à la section [Utilisation d’Uber Jar](https://experienceleague.adobe.com/fr/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) et incluez la dépendance suivante dans le POM de votre projet :
...
|----|-----|-----|-----|
| Intégration d’Assets et d’Adobe Creative Cloud | [Le partage de dossiers AEM vers Creative Cloud](https://experienceleague.adobe.com/fr/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) a été introduit dans AEM 6.2 afin de permettre aux créatifs d’accéder aux ressources depuis AEM. Une nouvelle fonctionnalité publiée dans l’application de Creative Cloud, Adobe Asset Link, offre une meilleure expérience utilisateur. Il permet également d’accéder plus facilement aux ressources d’AEM directement depuis Photoshop, InDesign et Illustrator.</br></br> Adobe n’apporte pas d’autres améliorations à la fonctionnalité de partage de dossiers. Bien que cette fonctionnalité soit incluse dans AEM, nous recommandons à la clientèle d’utiliser le remplacement. | Adobe Asset Link ou l’application de bureau. Pour plus d’informations, reportez-vous à l’article [Intégration AEM Creative Cloud](https://experienceleague.adobe.com/fr/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) . | AEM 6.3.3.x |
...
>* Abonnez-vous à [ Adobe Priority pour les mises à jour de produit ](https://www.adobe.com/subscription/priority-product-update.html)
