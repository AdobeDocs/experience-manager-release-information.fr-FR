...
<table>
 <tbody>
  <tr>
   ...
   <td><p>AEM prend en charge le chargement, la diffusion et l’aperçu interactif des ressources 3D dans le cadre du processus de création. La visionneuse 3D interactive est disponible à partir de la page des détails de la ressource dans AEM. La visionneuse comprend, entre autres, un ensemble de contrôles de caméra interactifs qui permettent d’orbiter, de zoomer et de faire un panoramique sur la ressource 3D.</p> <p>Voir la section <a href="https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html?lang=fr" target="_blank">Prévisualisation de ressources 3D</a>.</p> </td> 
  </tr>
  <tr>
   <td>12 décembre 2019</td> 
  ...
  <tr>
   ...
   <td>Archétype de projet AEM<br /> </td> 
   <td><a href="https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=fr">Archétype de projet AEM</a> crée un projet Adobe Experience Manager basé sur les bonnes pratiques comme point de départ de vos propres projets AEM.<br /> </td> 
  </tr>
  <tr>
   <td>18 octobre 2019<br /> </td> 
   <td>Gestion de l’expérience découplée<br /> </td> 
   <td>Fonctionnalités de <a href="https://experienceleague.adobe.com/docs/experience-manager-65/developing/spas/spa-ssr.html?lang=fr#remote-content-renderer">Moteur de rendu de contenu distant</a>, utilisés pour le rendu côté serveur des applications d’une seule page, ont été documentés.<br /> </td> 
  </tr>
  <tr>
  ...
  <tr>
   <td>25 septembre 2019</td> 
   <td>Scene7 : Workflow Retraiter les ressources<br /> </td> 
  ...
  <tr>
   <td>20 août 2019</td> 
   <td>Balises intelligentes AEM Assets<br /> </td> 
  ...
  <tr>
   <td>2 août 2019</td> 
   <td>Nouveau package PDF Rasterizer<br /> </td> 
  ...
  <tr>
   ...
   <td>Chargement de fichiers dans Dynamic Media Classic</td> 
  ...
  <tr>
   ...
   <td>Les bonnes pratiques sont mises à jour et mettent clairement en relation les besoins de l’entreprise, la gamme de solutions Adobe et les cas d’utilisation par des clients. Une infographie a été ajoutée pour en renforcer l’attrait visuel. Voir <a href="https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/aem-cc-integration-best-practices.html?lang=fr" target="_blank">Bonnes pratiques d’intégration d’AEM Creative Cloud</a>.<br /> </td> 
  </tr>
  <tr>
   <td>3 juin 2019</td> 
  ...
  <tr>
   <td>24 mai 2019</td> 
   <td>État des fonctionnalités de l’interface utilisateur tactile dans AEM 6.5<br /> </td> 
  ...
  <tr>
   ...
   <td><p><a href="https://experienceleague.adobe.com/docs/experience-manager-65/developing/introduction/reference-materials.html?lang=fr">Des documents de référence</a> sont disponibles, notamment :</p> 
    <ul> 
     ...
     <li>Documentation de l’API de l’interface utilisateur Granite (IU tactile)</li> 
...
Depuis le 1er mai 2023, les versions héritées de la documentation d’AEM ont été déplacées vers un nouvel emplacement à l’adresse [Anciennes versions d’Adobe Experience Manager, CQ et CRX](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html?lang=fr).
