...
Pour plus d’informations sur le CFP et sur d’autres types de versions, consultez le [Véhicule de version de maintenance](https://docs.adobe.com/content/docs/fr-FR/aem/6-2/deploy/maintenance-release-vehicle-definitions.html).
...
* La mise à niveau vers la dernière mise à jour 131 de Java 8 produit une exception : « Le fournisseur JsafeJCE est désactivé, une vérification d’intégrité FIPS 140 requise a échoué ». NPR-21355
   ...
   **Remarque :** Cette NPR nécessite des paramètres supplémentaires. Pour plus d’informations, reportez-vous à la [dernière mise à jour de Java 8](release-notes-aem-6-2-cumulative-fix-pack.md#latest-java-update-throws-an-exception-npr).
...
Liste des lots OSGi mis à jour entre AEM6.2 SP1 et CFP5

[Obtenir le fichier](assets/do-not-localize/cfp5_osgi_bundles.txt)

Liste des packages de contenu mis à jour entre AEM6.2 SP1 et CFP5
...
## Instructions de téléchargement du CFP via distribution de logiciels {#download-instructions-for-cfp-via-package-share}
...
1. Appuyez sur le nom du package, sélectionnez **[!UICONTROL Accepter les conditions du CLUF]**, puis appuyez sur **[!UICONTROL Télécharger]**.
...
>
>Vous pouvez accéder à la documentation de l’option Valider à l’adresse [https://docs.adobe.com/content/docs/fr-FR/aem/6-2/administer/content/package-manager.html#Package%20Validator](https://docs.adobe.com/content/docs/fr-FR/aem/6-2/administer/content/package-manager.html#Package%20Validator)
...
Voir la liste des [Problèmes connus dans AEM 6.2 SP1](https://docs.adobe.com/docs/fr-FR/aem/6-2/release-notes/sp1.html#Known).
...
>* [Notes de mise à jour d’AEM 6.2 SP1](https://docs.adobe.com/content/docs/fr-FR/aem/6-2/release-notes/sp1.html)
...
>* [Abonnement](https://campaign.adobe.com/webApp/adbePriorityProductSubscribe) aux [mises à jour de produits prioritaires d’Adobe](https://docs.adobe.com/content/help/fr/release-notes/experience-cloud/current.html)
